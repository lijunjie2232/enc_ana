...
def get_args():
    ...
    parser.add_argument(
        "--expand", type=int, default=1, help="parameter of Mamba Block"
    )
    parser.add_argument(
        "--d_conv", type=int, default=4, help="parameter of Mamba Block"
    )
    parser.add_argument(
        "--head_dim", type=int, default=64, help="parameter of Mamba Block"
    )
